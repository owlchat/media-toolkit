...
enum OwlchatResult owlchat_media_toolkit_dispatch(int64_t port, const uint8_t *data, uintptr_t len);
#endif
...
const struct Buffer *owlchat_media_toolkit_dispatch(const uint8_t *data, uintptr_t len);
#endif
...
//
// This function is unsafe because it deals with raw pointers.
void owlchat_media_toolkit_free_buffer(struct Buffer *buffer);
#endif
