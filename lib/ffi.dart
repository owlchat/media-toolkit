...
/// Owlchat Media Toolkit Bindings
class RawMediaToolkit {
  ...
  RawMediaToolkit(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RawMediaToolkit.fromLookup(
  ...
  int owlchat_media_toolkit_dispatch(
    int port,
    ffi.Pointer<ffi.Uint8> data,
    int len,
  ) {
    return _owlchat_media_toolkit_dispatch(
      port,
      data,
      len,
    );
  ...
  late final _owlchat_media_toolkit_dispatchPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Int64, ffi.Pointer<ffi.Uint8>,
              uintptr_t)>>('owlchat_media_toolkit_dispatch');
  late final _owlchat_media_toolkit_dispatch =
      _owlchat_media_toolkit_dispatchPtr
